                            ...
                            <div className="content ps-lg-4 d-flex flex-column justify-content-center">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <ul>
                                            <li><i className="bi bi-chevron-right" /> <strong>Name:</strong> <span>Harsh Vaishnani</span></li>
                                            <li><i className="bi bi-chevron-right" /> <strong>Website:</strong> <span>www.Hx Solutions.com</span></li>
                                            <li><i className="bi bi-chevron-right" /> <strong>Phone:</strong> <span>+90540 49820</span></li>
                                            <li><i className="bi bi-chevron-right" /> <strong>City:</strong> <span>Surat,Gujarat</span></li>
                                        </ul>
                                    </div>
                                    <div className="col-lg-6">
                                        <ul>
                                            ...
                                            <li><i className="bi bi-chevron-right" /> <strong>PhEmailone:</strong> <span>harshvaishnani2900.com</span></li>
                                            <li><i className="bi bi-chevron-right" /> <strong>Freelance:</strong> <span>Available 24/7 </span></li>
                                        </ul>
                                    </div>
                                </div>
